...
* 1 wrong filter function: filter(!is.na(total_cost)) 
...
* 1 mark for centred view (all/most points visible)
* 1 mark for appropriate zoom level (all/most points visible)
* 2 marks for Airbnb markers
* 2 marks for Art Gallery markers, 1 mark for pop-up functionality with Art Gallery name
* 2 marks for Mean Centre marker
* 1 marks for neighbourhood polygons, 1 mark for pop-up functionality with neighbourhood name
...
* 0 marks for name of Airbnb
* 0 marks for total cost of 5 night stay
* 1 marks for a URL link to Airbnb
...
### Mistake:
1) wrong filtering for NA total_cost
2) total_cost is calculated wrong: has to be (number of nights) * (price).